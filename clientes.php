...
<body>
    ...
    <p>Estes são os clienes cadastrados no seu sistema:</p>
    <table border="1" cellpadding="10">
        ...
        <tbody>
            <?php if($num_clientes == 0) { ?>
                <tr>
                    <td colspan="7">Nenhum clienge foi cadastrado</td>
                </tr>
            <?php 
            } else {
